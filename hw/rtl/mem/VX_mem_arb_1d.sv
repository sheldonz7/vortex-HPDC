...
module VX_mem_arb_1d #(
    ...
    parameter RSP_SEL        = 0   // always route response to the same input
) (
    input wire              clk,
    input wire              reset,
    ...
    assign rsp_valid_in[0] = bus_out_if[0].rsp_valid;
    assign rsp_data_in[0] = {
        bus_out_if[0].rsp_data.tag,
        bus_out_if[0].rsp_data.data
    };
    assign bus_out_if[0].rsp_ready = rsp_ready_in[0];
